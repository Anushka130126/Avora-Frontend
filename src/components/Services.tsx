    ...
    <section id="services" className="py-16 md:py-24 bg-slate-50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="md:col-span-2 bg-white/80 backdrop-blur-xl border border-black/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl p-6 md:p-8 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-xl md:text-2xl font-heading font-bold text-slate-900 mb-4">Agentic AI & LLM Integration</h3>
          ...
          {/* Medium Card 1 */}
          <div className="bg-white/80 backdrop-blur-xl border border-black/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl p-6 md:p-8 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 rounded-2xl bg-blue-50/50 border border-blue-100 flex items-center justify-center mb-6 text-blue-600">
                {services[1].icon}
              </div>
              <h3 className="text-lg md:text-xl font-heading font-bold text-slate-900 mb-3">Full-Stack Engineering</h3>
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-black/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl p-6 md:p-8 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg md:text-xl font-heading font-bold text-slate-900 mb-3">Enterprise BPO</h3>
              <p className="text-slate-600 leading-relaxed">
