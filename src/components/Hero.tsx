...
export default function Hero() {
  ...
  return (
    <section
      ref={container}
      className="relative min-h-[85vh] xl:min-h-screen flex flex-col justify-center xl:justify-end overflow-hidden bg-black"
    >
      ...
      {/* Content — Centered on mobile/tablet/iPadPro, Left aligned on large desktop */}
      <div className="relative z-10 w-full px-6 sm:px-10 xl:px-20 pb-0 xl:pb-24 max-w-screen-2xl mx-auto flex flex-col justify-center xl:justify-end h-full mt-20 xl:mt-0">
        <h1
