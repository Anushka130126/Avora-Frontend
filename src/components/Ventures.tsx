...
const caseStudies = [
  {
    ...
    context: "High-Fidelity Synthetic Image Datasets",
    headline: "For Data Generation: Engineered a synthetic volume library that expanded scarce training sets.",
    metric: "AUC 0.72 → 0.91",
    sub: "87 confirmed cases scaled to 50,000 volumes",
  },
  {
    domain: "Data Annotation",
    context: "Automated Crop Telemetry Datasets",
    headline: "For Data Annotation: Annotated high-density drone imagery covering diverse agricultural stresses.",
    metric: "Scouting: 3h → 25min",
    sub: "800,000 multispectral frames annotated",
  },
  {
    domain: "Labeling",
    context: "Document Processing & Extraction Pipelines",
    headline: "For Labeling: Operationalized OCR layout-analysis extraction across multi-format clinical sheets.",
    metric: "F1: 0.94 · Kappa: 0.90",
    sub: "2.1M pages across 47 distinct data points",
  },
  {
    domain: "AI Implementation",
    context: "Cognitive Demand Forecasting Pipelines",
    headline: "For AI Implementation: Integrated custom predictive ensemble models into local cloud infrastructure.",
    metric: "680% ROI at 36 months",
    sub: "40% task efficiency improvement demonstrated",
  },
];
